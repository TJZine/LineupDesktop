...
export function isValidChannelConfig(value: unknown): value is ChannelConfig {
  ...
  if (channel.sourceLibraryName !== undefined && typeof channel.sourceLibraryName !== 'string') return false;
  if (channel.isAutoGenerated !== undefined && typeof channel.isAutoGenerated !== 'boolean') return false;
  if (channel.isPlaybackModeVariant !== undefined && typeof channel.isPlaybackModeVariant !== 'boolean') {
    return false;
  }
