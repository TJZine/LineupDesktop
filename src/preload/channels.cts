...
export const LINEUP_CHANNEL_SETUP_GET_RECORD_CHANNEL = 'lineup:channelSetup:getRecord';
export const LINEUP_CHANNEL_SETUP_PREVIEW_CHANNEL = 'lineup:channelSetup:preview';
export const LINEUP_CHANNEL_SETUP_REVIEW_CHANNEL = 'lineup:channelSetup:review';
export const LINEUP_CHANNEL_SETUP_BUILD_CHANNEL = 'lineup:channelSetup:build';
export const LINEUP_CHANNEL_SETUP_CANCEL_BUILD_CHANNEL = 'lineup:channelSetup:cancelBuild';
export const LINEUP_CHANNEL_SETUP_PROGRESS_CHANNEL = 'lineup:channelSetup:progress';
