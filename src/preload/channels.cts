...
export const LINEUP_CHANNEL_SETUP_START_REVIEW_CHANNEL = 'lineup:channelSetup:startReview';
export const LINEUP_CHANNEL_SETUP_START_APPLY_CHANNEL = 'lineup:channelSetup:startApply';
...
export const LINEUP_GUIDE_CANCEL_PRESENTATION_CHANNEL = 'lineup:guide:cancelPresentation';
