...
const lineupDesktop: LineupDesktopPreloadApi = {
  ...
  channelSetup: createChannelSetupBridge(
    invokeChannelSetup,
    {
      on: (_channel, listener) => { ipcRenderer.on(LINEUP_CHANNEL_SETUP_PROGRESS_CHANNEL, listener); },
      removeListener: (_channel, listener) => {
        ipcRenderer.removeListener(LINEUP_CHANNEL_SETUP_PROGRESS_CHANNEL, listener);
      },
    },
    {
      getStatus: LINEUP_CHANNEL_SETUP_GET_STATUS_CHANNEL,
      commit: LINEUP_CHANNEL_SETUP_COMMIT_CHANNEL,
      getRecord: LINEUP_CHANNEL_SETUP_GET_RECORD_CHANNEL,
      preview: LINEUP_CHANNEL_SETUP_PREVIEW_CHANNEL,
      review: LINEUP_CHANNEL_SETUP_REVIEW_CHANNEL,
      build: LINEUP_CHANNEL_SETUP_BUILD_CHANNEL,
      cancelBuild: LINEUP_CHANNEL_SETUP_CANCEL_BUILD_CHANNEL,
      progress: LINEUP_CHANNEL_SETUP_PROGRESS_CHANNEL,
    },
    createRequestId,
  ),
