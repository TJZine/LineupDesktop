...
const lineupDesktop: LineupDesktopPreloadApi = {
  ...
  channelSetup: createChannelSetupBridge(invokeChannelSetup, {
    ...
    startReview: LINEUP_CHANNEL_SETUP_START_REVIEW_CHANNEL,
    startApply: LINEUP_CHANNEL_SETUP_START_APPLY_CHANNEL,
    getOperation: LINEUP_CHANNEL_SETUP_GET_OPERATION_CHANNEL,
    cancel: LINEUP_CHANNEL_SETUP_CANCEL_CHANNEL,
  }),
