...
UI parity is reopened before RD-27 by the active 2026-07-10 Tier 3 plan. RD-20
remains complete only as historical docs/source-audit/provenance work; it does
not prove current screen, focus, interaction, or runtime-backed visual parity.
...
is the tracked compatibility artifact for M01-M07 and M12 copied/adapted import
and ledger coverage, M08-M10 reference-only Desktop behavior, and M11 Desktop
proof context. Compatibility rows are closeout evidence only for the reviewed scope;
