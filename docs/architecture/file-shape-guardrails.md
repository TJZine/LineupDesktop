...
| src/renderer/index.ts | 532 | Main entrypoint of the renderer orchestration. Keeps route activation, action handling, gamepad, keyboard bindings, and lifecycle listeners in one place. Growth in Unit 2 adds channel buffer commit scheduling and mute/volume dispatch. | Extract gamepad, keyboard listeners, or action routing helpers before adding more route families or onboarding steps. |
