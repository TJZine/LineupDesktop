...
| src/main/index.ts | 544 | Main composition currently orchestrates startup initialization, runtime composition wiring, and diagnostic-safe fake resolver fallback while the production playback bridge hardening still evolves under constrained PR scope. | Decompose startup composition and fake-resolver bootstrap before adding additional runtime owners, richer startup diagnostics, or cross-runtime policy gates. |
