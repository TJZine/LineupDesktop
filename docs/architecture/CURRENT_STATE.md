...
> `6180815`, and `beeb5ef`. Production Unit 5D is committed at `81cf42c`;
> Unit 5E is the next authorized package. Windows composition proof remains
> deferred to 5H, so Unit 5D does not close `EPG-10`, `UI-36`, or WS5.
...
composition. Unit 5E is next. Windows composition proof is explicitly deferred
to 5H, so `EPG-10`, `UI-36`, affected parity rows, and WS5 remain open. WS6–WS9
remain unopened.
...
`46acf1f`, `6180815`, and `beeb5ef`; Unit 5D is committed at `81cf42c`.
Unit 5E is next, while Windows composition proof remains deferred to 5H. WS6
