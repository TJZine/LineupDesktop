...
> `6180815`, and `beeb5ef`. Production Unit 5D is the next authorized coding
> package; its Windows composition proof remains deferred to 5H and no 5D
> product code has landed yet.
...
Unit 5D is implementation-ready and next; its Windows composition proof is
explicitly deferred to 5H, so affected parity rows remain open. WS6–WS9 remain
unopened.
...
`46acf1f`, `6180815`, and `beeb5ef`. Production Unit 5D is next and authorized
for coding, while its Windows composition proof remains deferred to 5H. WS6
