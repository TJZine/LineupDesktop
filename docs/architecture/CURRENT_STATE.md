...
the app-owned Win32 child-window helper seam, and Player/Overlay/Classic Guide
...
generation. Unit 5H is next. Windows composition and
large-live-lineup proof is explicitly deferred to 5H, so `EPG-10`–`EPG-13`,
