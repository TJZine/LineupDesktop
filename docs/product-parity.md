...
| OSD hierarchy | Title/status, progress/buffer, up-next, tracks, sleep | At 1280×720 and 1920×1080, a responsive shallow bottom-edge gradient forms three broadcast zones—channel/program identity, progress/time, and grouped transport/secondary actions; the compact regime remains stacked so controls stay reachable | INTENTIONAL DESKTOP ADAPTATION | — | HIGH | `lib/playback/player_view.dart`; `test/playback/player_view_test.dart`; 1280×720 and 1920×1080 OSD goldens; screenshot `00-25-11` | Player UI |
