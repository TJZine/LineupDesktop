...
**Current gate:** UI parity remains active under the 2026-07-10 Tier 3 plan and
RD-27 is blocked. Package 6 production correction is implemented and reviewed;
Packages 7–8 renderer implementation may continue, but Package 6's mandatory
three-row Windows operator-assisted fullscreen audit remains an RD-27 gate. No
UI row may advance to platform-complete by substituting Mac diagnostics or
local automated proof for that audit.
