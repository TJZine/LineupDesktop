...
| EPG-11 | Detailed 2h versus Wide 3h density | `partial` | `partial` | Desktop implements exact Detailed/comfortable 2h (four 30-minute slots) and Wide/compact 3h (six 30-minute slots) windows locally; Windows/manual/current-upstream proof remains open in the WS5 5H campaign and `WS5-PROOF-06`. | P1 |
...
| ST-14 | Guide Density: Detailed 2h/Wide 3h | `partial` | `partial` | Persisted Detailed/Wide control now drives exact local windows: Detailed/comfortable is 2h (four 30-minute slots) and Wide/compact is 3h (six 30-minute slots) through Settings-to-Guide/Player settlement; Windows/manual/current-upstream proof remains open in the WS5 5H campaign and `WS5-PROOF-06`, with `WS3-CONTRIBUTION-WS5` still open. | P1 |
