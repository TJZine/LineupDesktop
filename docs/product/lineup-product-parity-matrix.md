...
**Current gate:** UI parity is reopened by the active 2026-07-10 Tier 3 plan
and RD-27 is blocked. No UI row may advance to product-complete or use RD-27 as
its next proof owner until the full-screen hierarchy, runtime truth,
focus/interaction matrix, exact two-viewport captures, and package reviews in
that plan close. Existing RD-27 cells below are downstream historical routing,
not authorization to bypass the reopen gate.
