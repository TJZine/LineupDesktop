...
Package 5 through the Tier 3 quality loop. Preserve the Packages 0–4 baseline.
Give the worker exact files, invariants, proof, and stop
conditions; pause after clean verification and independent review.
