...
> source does not retain the historical 256-program projection ceiling. That
> correction is adjudicated in the current audit without rewriting the
> original campaign boundaries below.
